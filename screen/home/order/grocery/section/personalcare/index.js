...
const List = (props) => {
    ...
    const _generateDataList = async () => {
        await axios.get('https://arukil.herokuapp.com/api/products/personalcare')
            .then(response => {
                return props.ADD_PERSONALCARE(response.data.data);
            }).catch(error => {
                console.log(error)
            })
    }
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            {/* { selectedProduct  ? console.log(selectedProduct) : null} */}
        </View >
